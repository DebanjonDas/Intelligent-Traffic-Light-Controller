...
| :---: | :---: |
| ![Design Phase 1](<images/Design structure1.png>) | ![Design Phase 5](<images/Design structure5.png>) |
| ![Design Phase 2](<images/Design structure2.png>) | ![Design Phase 6](<images/Design structure6.png>) |
| ![Design Phase 3](<images/Design structure3.png>) | ![Design Phase 7](<images/Design structure7.png>) |
| ![Design Phase 4](<images/Design structure4.png>) | *End of architectural layouts* |
...
| :---: | :--- |
| ![Output Log 1](<images/simulation output1.png>) | Full test suite initialization and baseline loops. |
| ![Output Log 2](<images/simulation output2.png>) | Pedestrian latch processing and emergency routing checks. |
| ![Output Log 3](<images/simulation output3.png>) | Simultaneous density stress test and safe exit verification. |
